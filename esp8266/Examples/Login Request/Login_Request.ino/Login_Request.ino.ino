...
static char *StaticPage = "<html>\
  ...
  <br>\
    <form method=\"post\" enctype=\"text/plain\" action=\"/settings/\">\
 <h4>Board Settings</h4>\
  ...
  <h4>MQTT</h4>\
    ...
    Password:<input type=\"text\" name=\"password\" value=\"%s\"><br><br>\
    <br><br>\
...
void handleRoot() {
  ...
  snprintf(Page,1024,StaticPage, "name1", "name2", "name3", "name1", "name1", "name1", "name1");
